...
<button
	on:click={restart}
	class="px-4 py-2 rounded-lg bg-slate-600 text-slate-200 font-semibold transition-all duration-200 hover:scale-105 hover:brightness-125 active:scale-90 disabled:opacity-50"
